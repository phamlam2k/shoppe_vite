      ...
      <header className="login-header">
        <div className="login-header-container">
          <div className="login-header-logo">
            <svg viewBox="0 0 192 65" className="login-logo-img">
              <g fill-rule="evenodd">
                <path
                  fill="#ee4d2d"
            ...
            <div className="login-header-text">Đăng Nhập</div>
          </div>
          <a href="#" className="login-header-link">
            Bạn cần giúp đỡ ?
          </a>
        </div>
      </header>
          ...
          <div className="login-form-grid">
            <div className="login-form-box">
              <div className="login-box-title">
                <p className="login-box-title-text">Đăng nhập</p>
              </div>
              <div className="body-login-input">
                ...
                <button className="login-button" id="login">
                  ĐĂNG NHẬP
                </button>
                ...
                <div className="social-login-box">
                  ...
                  <div className="social-login-text">HOẶC</div>
                  <div className="login-text"></div>
                </div>
                <div className="social-login">
                  ...
                  <div className="social-login-button">
                    ...
                    <div className="social-name">Apple</div>
                  </div>
                </div>
              </div>
        ...
        <div className="grid wide">
          <div className="footer-row">
            <div className="col l-2-4 c-6">
              <h3 className="footer_heading">Trung Tâm Trợ Giúp</h3>
            ...
            <div className="col l-2-4 c-6">
              ...
              <h3 className="footer_heading">Đơn Vị Vận Chuyển</h3>
              <div className="footer_partner">
                <img
            ...
            <div className="col l-2-4 c-6">
              ...
              <ul className="footer-list">
                <li className="footer-item">
                  <a href="#" className="footer-item_link">
                    <i className="footer-item_icon fa-brands fa-facebook"></i>
                    Facebook
                  </a>
                </li>
                <li className="footer-item">
                  <a href="#" className="footer-item_link">
                    <i className="footer-item_icon fa-brands fa-instagram"></i>
                    Instagram
                  </a>
                </li>
                <li className="footer-item">
                  <a href="#" className="footer-item_link">
                    <i className="footer-item_icon fa-brands fa-linkedin"></i>
                    LinkedIn
                  </a>
                </li>
              </ul>
          ...
          <div className="footer_privacy">
            <div className="footer_privacy-title">
              <span>CHÍNH SÁCH BẢO MẬT</span>
              <span>QUY CHẾ HOẠT ĐỘNG</span>
              <span>CHÍNH SÁCH VẬN CHUYỂN</span>
              <span> CHÍNH SÁCH TRẢ HÀNG VÀ HOÀN TIỀN </span>
            </div>
            <div className="footer_privacy-tag">
              <div className="footer_privacy-img-list">
                <img
                  className="footer_privacy-img"
                  src="https://cdn.dangkywebsitevoibocongthuong.com/wp-content/uploads/2018/06/logo.png"
                  alt="footer_privacy-tag"
                />
                <img
                  className="footer_privacy-img"
                  src="https://cdn.dangkywebsitevoibocongthuong.com/wp-content/uploads/2018/06/logo.png"
              ...
              <p className="footer_privacy-text">Công ty TNHH Shopee</p>
            </div>
            <div className="footer_privacy-location">
              <p className="footer_privacy-text">
                Địa chỉ: Tầng 4-5-6, Tòa nhà Capital Place, số 29 đường Liễu
                Giai, Phường Ngọc Khánh, Quận Ba Đình, Thành phố Hà Nội, Việt
                Nam. Tổng đài hỗ trợ: 19001221 - Email:s cskh@hotro.shopee.vn
              </p>
              <p className="footer_privacy-text">
